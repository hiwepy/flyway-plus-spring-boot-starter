...
| JDK | `17` |
| Coordinates | `io.github.easy4j:flyway-plus-spring-boot-starter:1.0.3.RELEASE` |
...
| Property Binding | ✅ Stable | Binds `flyway.plus.*` to `FlywayMigrationProperties` |
| `DataSource` bean | ✅ Stable | Auto-registered via FlywayMigrationAutoConfiguration |
...
| `else` | classpath + property | not created |
| `FlywayModuleMigrationInitializer` | classpath + property | not created |
