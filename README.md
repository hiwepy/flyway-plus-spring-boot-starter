...
| JDK | `17` |
| Coordinates | `io.github.easy4j:flyway-plus-spring-boot-starter:1.0.2.RELEASE` |
...
| `DataSource` bean | ✅ Stable | Auto-registered via FlywayMigrationAutoConfiguration, FlywayModularizedAutoConfiguration |
