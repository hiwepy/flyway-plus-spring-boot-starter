...
| JDK | `17` |
| 坐标 | `io.github.easy4j:flyway-plus-spring-boot-starter:1.0.3.RELEASE` |
| 配置前缀 | `flyway.plus` |
...
| `DataSource` Bean | ✅ 稳定 | 通过 FlywayMigrationAutoConfiguration 自动注册 |
...
| `else` | classpath + property | 不创建 |
| `FlywayModuleMigrationInitializer` | classpath + property | 不创建 |
